...
var Engine = (function(global) {
    ...
    function renderEntities() {
        ...
        // Checks if the player has reach the water.
        checkWin();
    }
    ...
    function checkCollisions() {
        ...
        allEnemies.forEach(function(enemy) {
            if(((player.x-20 < enemy.x) && (enemy.x<player.x+40)) 
                && ((player.y-20 < enemy.y) && (enemy.y < player.y+40))) {
    ...
    function checkWin() {
        if ((player.y-20 < 40 && 40 < player.y+40)) {
            reset();
            console.log("WIN!!!!!");
        }
    }
